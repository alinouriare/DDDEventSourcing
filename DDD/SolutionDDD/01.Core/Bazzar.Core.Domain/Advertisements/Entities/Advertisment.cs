   ...
   public class Advertisment: BaseAggregateRoot<Guid>
    {
        ...
        public Advertisment(Guid id, UserId ownerId)
        {
            ...
            HandleEvent(new AdvertismentCreated {Id=id,OwnerId=ownerId.Value });

        }

        public void SetTitle(AdvertismentTitle title)
        {
            HandleEvent(new AdvertismentTitleChanged { Id = Id ,Title=title.Value});
        }
        public void UpdateText(AdvertismentText text)
        {
            HandleEvent(new AdvertismentTextUpdated { Id = Id, AdvertismentText = text.Value });
        }
